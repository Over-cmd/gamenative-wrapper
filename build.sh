...
echo "=========================================================="
echo "🚀 INICIANDO ENLAZADOR MESA 25 CON BOOLEANOS ESTRICTOS (FIJADO)"
echo "=========================================================="
...
echo "-> 2b. Descargando código legítimo de libdrm SailfishOS..."
...
# Booleanos estrictos aplicados correctamente
...
echo "-> 3. Generando cross_64.txt definitivo..."
...
c_link_args = ['-landroid', '-llog', '-lsync', '-lvulkan_wrapper', '-L${NDK_SYSROOT_LIB_64}', '-L$WORKSPACE/shims_64/lib']
cpp_link_args = ['-landroid', '-llog', '-lsync', '-lvulkan_wrapper', '-L${NDK_SYSROOT_LIB_64}', '-L$WORKSPACE/shims_64/lib']
EOF

# Desactivar dependencias problemáticas del sistema host en la receta de Mesa
...
# Copiar interceptores y libdrm limpia sin sufijo numérico incompatible con Android nativo
