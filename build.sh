...
echo "=========================================================="
echo "🚀 INICIANDO ENLAZADOR MESA 25 - PRECISIÓN ABSOLUTA TRIPLE"
echo "=========================================================="

# 🟢 AJUSTE DE PRECISIÓN 1: Fijamos la ruta absoluta calculada al inicio para blindar cambios accidentales de directorio (cd)
WORKSPACE="$(pwd)"
...
echo "-> 3. Generando cross_64.txt definitivo acoplado a la variable absoluta WORKSPACE..."
...
# Amarramos libdrm.so de forma local mediante RUNPATH con retroceso $ORIGIN en el driver físico
...
# 🟢 AJUSTE DE PRECISIÓN 2: Sello local $ORIGIN en el interceptor suelto para amarrar sus llamadas a su mismo nivel jerárquico
