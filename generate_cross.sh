...
# 🟢 CORRECTOR DE PRECISIÓN DE RUTA: Alimentamos a Clang directamente desde el prefijo real aislado de shims_64 para no romper dependencias relativas ni duplicar carpetas
[built-in options]
